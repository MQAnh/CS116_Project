...
TRAIN_CANDIDATES_CHUNKS_DIR = PROCESSED_DIR / "train_candidates_chunks"
...
VALID_CANDIDATES_CHUNKS_DIR = PROCESSED_DIR / "valid_candidates_chunks"
...
FINAL_CANDIDATES_CHUNKS_DIR = PROCESSED_DIR / "final_candidates_chunks"
...
MIN_BILLS_ACTIVE_USER = 1
RECENT_TOP_K_TRAIN = 20
FREQUENT_TOP_K_TRAIN = 12
RECENT_TOP_K_VALID = 15
FREQUENT_TOP_K_VALID = 12
POPULAR_TOP_K = 0
...
COOCCURRENCE_ANCHOR_TOP_K = 12
COOCCURRENCE_TOP_K = 8
COOCCURRENCE_MAX_BILL_ITEMS = 20
...
RECENT_FALLBACK_FOR_ALL_USERS = True
