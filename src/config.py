...
FINAL_COOCCURRENCE_HISTORY_MONTHS = (10, 12)
FINAL_COOCCURRENCE_ANCHOR_TOP_K = 5
FINAL_COOCCURRENCE_TOP_K = 3
FINAL_COOCCURRENCE_MAX_BILL_ITEMS = 10
PREDICT_BATCH_SIZE = 2000_000
...
POPULAR_NEGATIVE_WEIGHT_COLUMN = "item_n_customers"
POPULAR_NEGATIVE_WEIGHT_ALPHA = 0.75
CLEAN_INTERMEDIATE_AFTER_TRAIN = True
RERANK_REPEAT_BOOST = 0.02
RERANK_AFFINITY_BOOST = 0.015
RERANK_POPULARITY_PENALTY = 0.015
